...
private const
*/
const THIRD_COMPANY_FORM_STORE_NAME = "thirdCompanyForm"; 
const GETTERS = {
  CHANGES: "CHANGES",
...
public const
*/
export const THIRD_COMPANY_FORM_STATE = {
  TYPE: `${THIRD_COMPANY_FORM_STORE_NAME}/type`
}
export const THIRD_COMPANY_FORM_DISPATCH = {
  CLOSE: `${THIRD_COMPANY_FORM_STORE_NAME}/${ACTIONS.CLOSE}`,
  LOAD: `${THIRD_COMPANY_FORM_STORE_NAME}/${ACTIONS.LOAD}`,
  SAVE: `${THIRD_COMPANY_FORM_STORE_NAME}/${ACTIONS.SAVE}`,
  UPDATE: `${THIRD_COMPANY_FORM_STORE_NAME}/${ACTIONS.UPDATE}`,
  COPY: `${THIRD_COMPANY_FORM_STORE_NAME}/${ACTIONS.COPY}`
}
export const THIRD_COMPANY_FORM_COMMIT = {
  MODIFY: `${THIRD_COMPANY_FORM_STORE_NAME}/${MUTATIONS.MODIFY}`,
  ADD: `${THIRD_COMPANY_FORM_STORE_NAME}/${MUTATIONS.ADD}`,
  REMOVE: `${THIRD_COMPANY_FORM_STORE_NAME}/${MUTATIONS.REMOVE}`,
  RESET_CHANGES: `${THIRD_COMPANY_FORM_STORE_NAME}/${MUTATIONS.RESET_CHANGES}`,
  RESET_FTS: `${THIRD_COMPANY_FORM_STORE_NAME}/${MUTATIONS.RESET_FTS}`
}
export const THIRD_COMPANY_FORM_GETTERS = {
  IS_CHANGED: `${THIRD_COMPANY_FORM_STORE_NAME}/${GETTERS.IS_CHANGED}`,
  FTS: `${THIRD_COMPANY_FORM_STORE_NAME}/${GETTERS.FTS}`,
  ITEMS: `${THIRD_COMPANY_FORM_STORE_NAME}/${GETTERS.ITEMS}`,
  ORIGINS: `${THIRD_COMPANY_FORM_STORE_NAME}/${GETTERS.ORIGINS}`,
}
/*
 * Private mutations
 */
