...
private const
*/
const CLIENT_FORM_STORE_NAME = "clientForm"; 
const GETTERS = {
  CHANGES: "CHANGES",
...
public const
*/
export const CLIENT_FORM_STATE = {
  TYPE: `${CLIENT_FORM_STORE_NAME}/type`
}
export const CLIENT_FORM_DISPATCH = {
  CLOSE: `${CLIENT_FORM_STORE_NAME}/${ACTIONS.CLOSE}`,
  LOAD: `${CLIENT_FORM_STORE_NAME}/${ACTIONS.LOAD}`,
  SAVE: `${CLIENT_FORM_STORE_NAME}/${ACTIONS.SAVE}`,
  UPDATE: `${CLIENT_FORM_STORE_NAME}/${ACTIONS.UPDATE}`,
  COPY: `${CLIENT_FORM_STORE_NAME}/${ACTIONS.COPY}`
}
export const CLIENT_FORM_COMMIT = {
  MODIFY: `${CLIENT_FORM_STORE_NAME}/${MUTATIONS.MODIFY}`,
  ADD: `${CLIENT_FORM_STORE_NAME}/${MUTATIONS.ADD}`,
  REMOVE: `${CLIENT_FORM_STORE_NAME}/${MUTATIONS.REMOVE}`,
  RESET_CHANGES: `${CLIENT_FORM_STORE_NAME}/${MUTATIONS.RESET_CHANGES}`,
  RESET_FTS: `${CLIENT_FORM_STORE_NAME}/${MUTATIONS.RESET_FTS}`
}
export const CLIENT_FORM_GETTERS = {
  IS_CHANGED: `${CLIENT_FORM_STORE_NAME}/${GETTERS.IS_CHANGED}`,
  FTS: `${CLIENT_FORM_STORE_NAME}/${GETTERS.FTS}`,
  ITEMS: `${CLIENT_FORM_STORE_NAME}/${GETTERS.ITEMS}`,
  ORIGINS: `${CLIENT_FORM_STORE_NAME}/${GETTERS.ORIGINS}`,
}
/*
 * Private mutations
 */
